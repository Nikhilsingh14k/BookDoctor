...
{/* till here right section */}
          </div>  
        </div>
 {/* about section  */}
          <div className='flex-1 flex flex-col gap-1'>
              <p className='mt-4 mb-2'>About Doctor</p>
              <textarea onChange={(e)=>setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border rounded' type="text" placeholder='Write bout Doctor' rows={5} required/>
          </div>
